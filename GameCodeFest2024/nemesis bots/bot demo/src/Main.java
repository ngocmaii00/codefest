...
public class Main {
    ...
    private static final String GAME_ID = "135148";
    private static final String PLAYER_NAME = "test-pass N1";
...
//================================================================================================================
                    ...
                    if (Action.calDistance(player, target) == 1.d && target.getIsAlive()) {
