...
public class Action {
    ...
    public static boolean slashed = true;
    ...
    public static <T extends Element> T getNoNull(GameMap gameMap,Player player, List<T> list,List<Node> restrictedPoints ){


            int index = 0;
            while (!PathUtils.checkInsideSafeArea(list.get(index), gameMap.getDarkAreaSize() + 4, gameMap.getMapSize())
                    || PathUtils.getShortestPath(gameMap, restrictedPoints, player, list.get(index), false) == null) {
